...
function Arrow(options) {
    ...
    var element = document.createElement('img'),
         ...
         * arrow.</br> В переменную будет записываться текущее значение свойства opacity arrow.</br> Это нужно для того,
    ...
    chrome.storage.sync.get(function (items) {
        element.style.opacity = items.opacity || 0.2;
    });
    ...
    /**
     * Устанавливает степень прозрачности кнопки
     * @method setOpacity
    ...
    /**
     * Срабатывает при нахождении курсора над dom элементом стрелки.</br>
    ...
    /**
     * Срабатывает при выходе курсора с dom элемента стрелки.</br>
     * Свойство opacity элемента при этом устанавливается в первоначальное значение
     * @event onmouseover
     * @param {Object} event
     */
    element.onmouseout = function (event) {
        this.style.opacity = last_opacity;
    };
}
